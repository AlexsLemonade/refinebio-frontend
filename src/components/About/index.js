    ...
    <div className="about">
      ...
      <div className="about__section about__info-item">
        ...
        <div>
          ...
          <div className="about__info-item-text">
            ...
            own language. Different studies use distinct technologies to collect
            the same type of data, and each technology has its own language.
            Researchers can spend up to 30% of their time translating these
            datasets into something they can use. This cumbersome process takes
            away valuable resources that could be spent in the lab discovering
      ...
      <div className="about__section about__info-item">
        ...
        <div>
          ...
          <div className="about__info-item-text">
            refine.bio is here to fix that. It’s the Rosetta Stone for the vast
            amount of publicly available childhood cancer data. It’s the first
            project of its kind to harmonize this information across many
            different technologies into one universal repository. Now
      ...
      <div className="about__section about__info-item">
        ...
        <div>
          ...
          <div className="about__info-item-text">
            ...
            basis, further enhancing the burgeoning field of precision medicine.
          </div>
        </div>
      </div>
