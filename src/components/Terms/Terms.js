...
const Terms = () => (
  <div className="terms">
    ...
    <p>
      ...
      downloading, installing or using the CCDL, or any software, applications,
      data or other content available on or through the CCDL (collectively,{' '}
      <strong>"Content"</strong> and any such data, <strong>"Data"</strong>),
      you agree to be bound by these Terms and to use the CCDL, including any
      Content, in accordance with these Terms. If you are using the CCDL on
    ...
    <p>
      ...
      subject to the policies, guidelines and terms applicable to such features
      (collectively, as may be updated from time to time,{' '}
    ...
    <p>
      We may periodically make changes to these Terms, and we will identify the
      date of last update below. We will post the updated Terms on the CCDL, and
      we will use commercially reasonable efforts to post changes in advance if
      we reasonably determine that such changes are material. We may also, in
      our discretion, use other commercially reasonable methods to attempt to
      notify you of such changes. Changes to these Terms will be effective upon
      posting on the CCDL. We encourage you to review the most recent version of
      these Terms frequently. If you continue to use the CCDL after we modify
      these Terms, you will be deemed to have consented to the updated Terms as
    ...
    <ol className="terms__list--bold">
      ...
      <li>
          ...
          <li>
            ...
            <ol className="terms__list" type="i">
              <li>
                ...
                the Data contributor of that Data set (as applicable), and (ii)
                us using the language posted on the CCDL or otherwise provided
                by us;
              </li>
              <li>
              ...
              <li>
                ...
                entity in any way, or falsely imply that any third-party service
                is associated with the CCDL;
              </li>
              <li>
                upload or otherwise transmit to or through the CCDL any Content
                that infringes, misappropriates, or violates any third-party
                right; that violates, or causes us or our affiliates to violate,
                any applicable law or regulation; that is unlawful, harmful,
                harassing, defamatory, threatening, hateful or otherwise
                objectionable or inappropriate; or that can cause harm or delay
                to the CCDL (or any connected or related systems) or can expose
                us or other Users to risk of harm, damage, liability or loss;
              </li>
              <li>
              ...
              <li>
                ...
                junk mail, spam, or any other form of solicitation (commercial
                or otherwise);
              </li>
              <li>
                distribute, disclose, market, rent, lease or otherwise transfer
                the CCDL to any other individual or entity;
              </li>
              <li>
              ...
              <li>
                ...
                interfere with any security-related features of the CCDL, except
                that you may use passwords and other credentials we provide
                solely as expressly authorized and intended;
              </li>
              <li>
                interfere with or disrupt the CCDL (or any related or connected
                systems) or violate the regulations, policies or procedures of
                any CCDL-related systems;
              </li>
              <li>
        ...
        <p>
          ...
          practicable. We (or our designee) may use any reasonable, lawful tools
          or methods to monitor use of the CCDL and compliance with these Terms.
        </p>
      </li>
      <li>
        Confidentiality
        <p>
          ...
          obtain or access via, regarding or in connection with the CCDL that is
          marked as confidential or should reasonably be treated as confidential
          (excluding information specifically identified by us or the source as
          non-confidential).
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          or permanently, all or part of the CCDL (including any Content)
          ...
          any modification, discontinuance or restriction of the CCDL or any
          deletion of any Data or other Content stored on, or otherwise
          associated with, your account on the CCDL.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          must immediately cease using the CCDL. All provisions of these Terms
          that by their nature should survive (including, without limitation,
          provisions governing indemnification, limitations of liability,
          confidentiality, warranty disclaimers, use restrictions, and
          intellectual property rights) will continue to remain in full force
          and effect after any termination.
        </p>
      </li>
      <li>
        Feedback
        <p>
          ...
          CCDL, submitted by you to us or the CCDL (collectively,{' '}
          <strong>"Feedback"</strong>) are non-confidential (notwithstanding any
      ...
      <li>
        ...
        <p>
          ...
          believe that your work has been posted on the CCDL in a way that
          ...
          displayed on the CCDL; (c) your address, telephone number, and email
          address; (d) a statement by you that you have a good faith belief that
          the disputed use is not authorized by the copyright owner, its agent,
          or the law; and (e) a statement by you, made under penalty of perjury,
      ...
      <li>
        ...
        <p>
          ...
          and to the CCDL. We reserve all rights not expressly granted to you in
          these Terms.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          <strong>"Third-Party Content"</strong>). Your access to or use of any
          Third-Party Content is at your sole risk. We do not monitor, endorse,
          or adopt, or have any control over, any Third-Party Content. Under no
          ...
          subject to separate terms and conditions. You should review, and you
          are solely responsible for complying with, any such third-party terms.
          You acknowledge and agree that we may use third-party vendors and
          hosting partners to provide the hardware, software, networking,
          storage, and related technology used to operate the CCDL.
        </p>
      </li>
      <li>
        Indemnification
        <p>
          ...
          the CCDL (or any activity under your account or credentials), your
      ...
      <li>
        ...
        <p className="terms__caps">
          ...
          available thereon or associated therewith, including without
          limitation the implied warranties of merchantability, non-infringement
          and fitness for a particular purpose; and (b) the ccdl is provided "as
      ...
      <li>
        ...
        <p className="terms__caps">
          ...
          ccdl or any services or content made available through the ccdl,
        ...
        <p className="terms__caps">
          ...
          extent permissible under applicable law. the limitations in this
      ...
      <li>
        ...
        <ol type="a" className="terms__list">
          ...
          <li>
            <em>Jurisdiction.</em> Unless otherwise agreed in writing between
      ...
      <li>
        ...
        <p>
          ...
          <strong>
            Any dispute or claim arising out of or relating to the CCDL or these
            Terms must be commenced within one year after the claim arose.
          </strong>
        </p>
        <p>
